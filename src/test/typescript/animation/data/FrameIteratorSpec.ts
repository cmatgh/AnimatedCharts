...
import {FrameIterator} from "../../../../main/typescript/animatedcharts/animation/data/FrameIterator";
...
describe("FrameIterator", () => {
    ...
    describe("constructor", () => {
        it("should throw error when frame is out of range", () => {
            ...
            expect(() => new FrameIterator(frameData, 2)).to.throw(RangeError);
            expect(() => new FrameIterator([], -1)).to.throw(RangeError);
        });
    })
    ...
    describe("getCurrentFrame", () => {
        it("should return null if list is empty", () => {
            ...
            const iterator = new FrameIterator(frameData);
        ...
        it("should return correct value when cycling", () => {
            ...
            const iterator = new FrameIterator(frameData, 2);
            iterator.getNext();
            iterator.getNext();
