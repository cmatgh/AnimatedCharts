...
describe("LabelVisitor", () => {
    ...
    //         // given
    //         const button = new InputPresenter("", "Label", null);
    //         labelVisitor = new LabelVisitor();
    //
    //         // when
    ...
    //
    //         //then
    //         expect(button.getElement().text()).to.be.eq("Label");
    //     })
    //
    ...
    //
    //         //then
    //         expect(button.getElement().html()).to.be.eq("<a>Label</a>")
    //     })
    //
    ...
    //
    //         //then
    //         expect(button.getElement().html()).to.be.eq("<a><b>Label</b></a>")
    //     })
    //
    ...
    //
    //         //then
    //         expect(button.getElement().html()).to.be.eq("Label")
    //     })
    //
    ...
    //         // given
    //         const animationUI = new AnimationPresenterImpl("animationUI", "title");
    //         labelVisitor = new LabelVisitor();
    //         labelVisitor.addDecorator(new NodeLabelStylingDecorator("a"));
    //         labelVisitor.addDecorator(new NodeLabelStylingDecorator("b"));
